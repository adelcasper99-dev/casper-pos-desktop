            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-card/50 backdrop-blur-md p-5 rounded-2xl border border-white/5 flex flex-col gap-2 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-3 text-zinc-400">
                        ...
                        <span className="font-medium text-sm">Expected Salaries</span>
                    </div>
                    {isLoadingSummary ? (
                ...
                <div className="bg-card/50 backdrop-blur-md p-5 rounded-2xl border border-white/5 flex flex-col gap-2 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-3 text-zinc-400">
                        ...
                        <span className="font-medium text-sm">Total Absences</span>
                    </div>
                    {isLoadingSummary ? (
                ...
                <div className="bg-card/50 backdrop-blur-md p-5 rounded-2xl border border-white/5 flex flex-col gap-2 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-3 text-zinc-400">
                        ...
                        <span className="font-medium text-sm">Employee Credit Sales</span>
                    </div>
                    {isLoadingSummary ? (
                        <div className="h-8 w-24 bg-white/5 rounded-lg animate-pulse mt-1" />
                    ) : (
