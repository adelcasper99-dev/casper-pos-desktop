...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header { width:100%; text-align:center; padding-bottom:3mm; border-bottom:0.5mm solid #000; margin-bottom:2mm; display:flex; flex-direction:column; align-items:center; }
    ...
    .ticket-badge { margin-top:3mm; border:0.7mm solid #000; padding:1.5mm 4mm; font-size:20px; font-weight:900; background:#000; color:#fff; display:inline-block; }
    .section { padding:2mm 1mm; border-bottom:0.3mm solid #000; font-size:11px; }
    .section-title { font-size:10px; font-weight:900; text-transform:uppercase; opacity:.7; margin-bottom:1mm; }
    .row { display:flex; justify-content:space-between; align-items:center; }
    .total-box { background:#000; color:#fff; margin:3mm 0; padding:3mm 2mm; border-radius:1mm; }
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header { width:100%; text-align:center; padding-bottom:1mm; border-bottom:0.5mm solid #000; margin-bottom:1.5mm; display:flex; flex-direction:column; align-items:center; justify-content: flex-start; }
    .shop-logo { max-width:35mm; max-height:15mm; margin-bottom:1.5mm; object-fit:contain; filter:grayscale(1) contrast(1.5); }
    .shop-name { font-size:16px; font-weight:700; letter-spacing:0.5mm; line-height: 1.2; }
    .ticket-badge { margin-top:2.5mm; border:0.7mm solid #000; padding:1.5mm 4mm; font-size:20px; font-weight:900; background:#000; color:#fff; display:inline-block; }
    .copy-type { margin-top:1mm; font-size:11px; font-weight:900; background:#fff; color:#000; border:0.5mm solid #000; padding:0.5mm 3mm; border-radius:1mm; text-transform:uppercase; }
    .section { padding:2mm 1mm; border-bottom:0.3mm solid #000; font-size:11px; }
    .section-title { font-size:9px; font-weight:900; text-transform:uppercase; opacity:1; margin-bottom:1mm; color: #555; }
    .row { display:flex; justify-content:space-between; align-items:center; }
    .entry-field { margin-top:1mm; border-bottom:0.3mm solid #000; height:10mm; display:flex; align-items:center; font-size:8px; color:#000; }
    .entry-label { white-space:nowrap; margin-left:1mm; font-weight: 700; }
    .entry-line { flex-grow:1; border-bottom:0.2mm dotted #000; margin-bottom:1.5mm; margin-right:1mm; opacity:1; }
  </style>
</head>
<body>
  <div class="header">
