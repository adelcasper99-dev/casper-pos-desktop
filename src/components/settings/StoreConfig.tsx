                   ...
                   <>
                    ...
                    <>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between p-4 border border-white/10 rounded-xl bg-white/5">
                                <div className="space-y-0.5">
                                    <Label className="text-sm font-medium text-white">{t('autoPrintEngineerCopy')}</Label>
                                    <p className="text-xs text-zinc-400">{t('autoPrintEngineerCopyDesc')}</p>
                                </div>
                                <Switch
                                    checked={form.autoPrintEngineerCopy || false}
                                    onCheckedChange={(checked) => handleChange('autoPrintEngineerCopy', checked)}
                                />
                            </div>
