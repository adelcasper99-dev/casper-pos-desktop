        ...
        <div className="w-full max-w-2xl px-4 animate-in fade-in slide-in-from-top-8 duration-500">
            ...
            <div className="flex flex-col items-center justify-center text-center mb-8 gap-3">
                ...
                <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="text-xs text-slate-500 font-bold uppercase tracking-wider ml-1">Step 1 of 2: Activation</span>
                </div>
            </div>
            ...
            <Card className="glass-card bg-slate-900/40 border-slate-800/80 shadow-2xl relative overflow-hidden backdrop-blur-xl">
                ...
                <CardHeader className="text-center border-b border-slate-800/50 pb-6 relative z-10">
                    <CardTitle className="text-xl text-white">Choose Onboarding Method</CardTitle>
                    <CardDescription className="text-slate-400">Select how you want to initialize this client node.</CardDescription>
                </CardHeader>
                    ...
                    {!showActivation ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col p-5 rounded-2xl border border-slate-800 bg-slate-950/40 hover:border-cyan-500/30 transition-all duration-300 group">
                                ...
                                <h3 className="text-md font-bold text-white mb-2">30-Day Free Trial</h3>
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <>
                                            Start Trial <Play className="w-4 h-4 fill-slate-950" />
                                        </>
                                    )}
                                </Button>
                            </div>
                            ...
                            {/* Option B: License */}
                            <div className="flex flex-col p-5 rounded-2xl border border-slate-800 bg-slate-950/40 hover:border-violet-500/30 transition-all duration-300 group">
                                <div className="p-3 w-max rounded-xl bg-violet-500/10 text-violet-400 mb-4 group-hover:scale-110 transition-transform">
                                    <KeyRound className="w-5 h-5" />
                                </div>
                                <h3 className="text-md font-bold text-white mb-2">Activate Client Key</h3>
                                <p className="text-xs text-slate-400 mb-6 leading-relaxed flex-1">
                                ...
                                >
                                    Activate Key <ArrowRight className="w-4 h-4" />
                                </Button>
                            </div>
                        </div>
                    ) : (
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-[10px] text-slate-500 font-semibold uppercase tracking-wider">Production Setup</span>
                            </div>

                            {/* Reuses standard Activation form */}
                            <div className="border border-slate-800 rounded-xl bg-slate-950/20 p-2">
                                <ActivateForm />
                            </div>
                        </div>
                    )}
